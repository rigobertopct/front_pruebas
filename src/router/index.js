...
import Departamentos from "@/views/Organizacion/Departamentos.vue";
import Areas from "@/views/Organizacion/Areas.vue";
import Lugares from "@/views/Organizacion/Lugares.vue";
import Evaluacion from "@/views/Organizacion/Evaluacion.vue";
import Usuarios from "@/views/Seguridad/Usuarios.vue";
import Servicios from "@/views/Servicios/Servicios.vue";
import Indicadores from "@/views/Servicios/Indicadores.vue";
